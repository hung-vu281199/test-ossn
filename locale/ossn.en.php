...
%s",
    ...
    'category:created' => 'Your category has been created.',
    'category:updated' => 'Category updated!',
    'category:create:error:admin' => 'Add new category failed! Please try again later.',
...
%s",
    ...
    'admin:categories:list' => 'Categories List',
    'admin:add:category' => 'Add Category',
    'admin:edit:category' => 'Edit Category',
    'admin:category:deleted' => 'Category has been deleted!',
    'admin:category:delete:error' => 'Unable to delete category. Please try again later.',


    /*Point*/
    'admin.point:manager' => 'Point Setting Manager',
    'admin.add:point' => 'Add  New Point Setting',
    'admin.edit:point' => 'Edit Point Setting',
    'point:created' => 'Point Setting Created',
    'point:updated' => 'Point Setting Updated',
    'code' => 'Code',
    'value' => 'Value',



    'ossn:category:delete:exception' => 'Are you sure you want to delete this category?',
    'ossn:category:name:inuse' => 'The following category is taken. Please select a different one.',
    ...
    'admin:sidemenu:categories' => 'Categories Manager',
    'admin:sidemenu:point' => 'Point Manager',
    'cancel' => 'Cancel',
