...
function ossn_goblue_head(){
    ...
    $head[]  = ossn_html_js(array(
        'src' => ossn_theme_url() . 'vendors/select2/js/select2.full.js'
    ));

    $head[]  = ossn_html_css(array(
        'href' => ossn_theme_url() . 'vendors/select2/css/select2.min.css'
    ));
    $head[]  = ossn_html_css(array(
        'href' => ossn_theme_url() . 'vendors/select2/css/select2-bootstrap-5-theme.css'
    ));
